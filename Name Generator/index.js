...
const randomIndexForAdj = Math.floor(Math.random() * adj.length);
const randomAdj = adj[randomIndexForAdj];
const randomIndexForNoun = Math.floor(Math.random() * noun.length);
const randomNoun = noun[randomIndexForAdj];
